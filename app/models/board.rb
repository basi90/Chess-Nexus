...
class Board
  ...
  def setup_board
    @board_state[0][0] = Rook.new(:black)
    @board_state[0][1] = Knight.new(:black)
    @board_state[0][2] = Bishop.new(:black)
    @board_state[0][3] = Queen.new(:black)
    @board_state[0][4] = King.new(:black)
    @board_state[0][5] = Bishop.new(:black)
    ...
    @board_state[7][2] = Bishop.new(:white)
    @board_state[7][3] = Queen.new(:white)
    @board_state[7][4] = King.new(:white)
    @board_state[7][5] = Bishop.new(:white)
