...
export default class extends Controller {
  ...
  #buildMessageElement(currentUserIsSender, message) {
    return `
      <div class="message-row d-flex ${this.#justifyClass(currentUserIsSender)}">
        ${this.#showOpponentProfilePicture(currentUserIsSender)}
  ...
  #showOpponentProfilePicture(currentUserIsSender) {
    return currentUserIsSender ? "" : `<img width="40" height="40" class="rounded-circle" alt="profile picture" src="http://res.cloudinary.com/dy3qbninr/image/upload/c_fill,h_40,w_40/v1/development/${this.opponentPictureKeyValue}"></img>`
  }
